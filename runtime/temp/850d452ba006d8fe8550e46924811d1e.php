<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"F:\Demo\tpshop\public/../application/admin\view\user\editrole.html";i:1501054630;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="/admin/user/editrole?id=<?php echo $role['id']; ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $role['title']; ?>" placeholder=""  name="title" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
						...
						<dl class="cl permission-list2">
							...
							<?php foreach($data as $vo): if($vo['class']==1): ?>
								<label class="">
									...
									<input type="checkbox" value="<?php echo $vo['id']; ?>" name="check[]" id="user-Character-0-0-0" <?php if((in_array($vo['id'],$role['rules']))): ?>checked<?php endif; ?>>
